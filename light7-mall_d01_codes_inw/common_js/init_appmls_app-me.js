...
$append_mls.appendIni(
{
	meta : [
			{
				...
				// } ,
				// "light7" : {
				// 		href : document.baseURI + "dist/css/light7.css" ,
				// 		domParent : "body" ,
				// 	} ,
			} ,
	] ,			
	link : [
				...
				} ,
				{
					...
					// "app-css" : document.baseURI + "examples/light7-mall_c01/css/app.css" ,
				} ,
	...
	script : [
				{
					...
					// zepto : document.baseURI + "//g.alicdn.com/sj/lib/zepto/zepto.js" ,
				...
				} ,
				{
					...
					"login-get-json" : document.baseURI + "assets/js/login-get-json.js" ,

					"init" : document.baseURI + "examples/light7-mall_c01/js/init.js" ,
				} ,
				{
					
					// "light7" : document.baseURI + "dist/css/light7.css" ,
					// "light7-swiper" : {
					// 	href : document.baseURI + "dist/css/light7-swiper.css" ,
					// 	domParent : "body" ,
					// } ,
					// "light7-swipeout" : {
					// 	href : document.baseURI + "dist/css/light7-swipeout.css" ,
					// 	domParent : "body" ,
					// } ,
				} ,
			] ,
